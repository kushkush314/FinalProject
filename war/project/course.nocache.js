...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "course" because\n';
  ...
  $wnd.__gwt_activeModules['course'] = {
    'moduleName' : 'course',
    'bindings' : function() {
      return {};
    }
 ...
 * "/course.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['course'].superdevmode = true;

  var expectedSuffix = '/course.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + course + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:course';
  var devModeSessionKey = '__gwtDevModeSession:course';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/course/course.nocache.js';
  ...
  $wnd.__gwt_activeModules['course'].canRedirect = true;
  $wnd.__gwt_activeModules['course'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/course?user.agent=' + ua + '&_callback=' + callback;
